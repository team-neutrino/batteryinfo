...
def plot():
    ...
    color = ['#6bfa43', '#fa9a25', '#face2f', '#25f6fa', '#0f84fa', '#be11f2', '#1c5922', '#fc1921', '#99ebf0', '#837896', '#f547cc', '#bf2cf5', '#b596a4', '#a3c2a8', '#c2bf67', '#825621', '#21211c', '#f547cc', '#a3c2a8', '#25f6fa', '#b596a4']
    for j in range(2):
